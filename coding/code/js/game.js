...
const gameBackground = {
	//game parallex를 적용할 
	gameBox : document.querySelector('.game')//hero가 이동한 값 
	//페럴럭스 효과는 game에 적용 
}
const renderGame = () => {
